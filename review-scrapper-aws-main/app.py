...
def index():
    if request.method == 'POST':
        try:
            ...
            uri = "mongodb+srv://Thunder_Damo1606:DJdamo1606@cluster0.mdyyrid.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
            ...
            if reviews:
                result = review_col.insert_many(reviews)
